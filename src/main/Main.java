        ...
        while (!GameController.getInstance().checkGameEnd()) {
            ...
            while (true) {
                ...
                if (option == 0) {
                    ...
                    GameController.getInstance().monsters.get(GameController.getInstance().monsters.size() - 1)
                            .setFood(new Food("Meat", 40, 6));
                    GameController.getInstance().monsters.get(GameController.getInstance().monsters.size() - 1)
                            .setPotion(new Potion("Expense Potion", 50, GameController.createNewStatus(4, 4, 4, 4)));
                    ...
                    if (status == null)
                        continue;
                    GameController.getInstance().markets.get(market).getPotions()
                            .add(new Potion(potionName, price, status));
                    ...
                    for (int i = 0; i < GameController.getInstance().players.size(); i++) {
                        System.out.println(
                                "<" + i + "> " + "Player: " + GameController.getInstance().players.get(i).getName());
                        System.out.println("Hp: " + GameController.getInstance().players.get(i).getStatus().getHp()
                                + " Durability: "
                                + GameController.getInstance().players.get(i).getStatus().getDurability()
                                + " Attack: " + GameController.getInstance().players.get(i).getStatus().getAttack()
                                + " Magic: " + GameController.getInstance().players.get(i).getStatus().getMagic()
                                + " Energy: " + GameController.getInstance().players.get(i).getEnergy() + " Money: "
                                + GameController.getInstance().players.get(i).getMoney());
                    }
                    ...
                    System.out.println("Hp: " + GameController.getInstance().players.get(player).getStatus().getHp()
                            + " Durability: "
                            + GameController.getInstance().players.get(player).getStatus().getDurability()
                            + " Attack: " + GameController.getInstance().players.get(player).getStatus().getAttack()
                            + " Magic: " + GameController.getInstance().players.get(player).getStatus().getMagic()
                            + " Energy: " + GameController.getInstance().players.get(player).getEnergy() + " Money: "
                            + GameController.getInstance().players.get(player).getMoney());
                    ...
                    for (int i = 0; i < GameController.getInstance().players.get(player).getPotions().size(); i++) {
                        System.out.println(
                                GameController.getInstance().players.get(player).getPotions().get(i).getName());
                    }
                    ...
                    for (int i = 0; i < GameController.getInstance().monsters.size(); i++) {
                        System.out.println(
                                "<" + i + "> " + "Monster: " + GameController.getInstance().monsters.get(i).getName());
                        System.out.println("Hp: " + GameController.getInstance().monsters.get(i).getStatus().getHp()
                                + " Durability: "
                                + GameController.getInstance().monsters.get(i).getStatus().getDurability()
                                + " Attack: " + GameController.getInstance().monsters.get(i).getStatus().getAttack()
                                + " Magic: " + GameController.getInstance().monsters.get(i).getStatus().getMagic());
                    }
                    ...
                    System.out.println("Hp: " + GameController.getInstance().monsters.get(monster).getStatus().getHp()
                            + " Durability: "
                            + GameController.getInstance().monsters.get(monster).getStatus().getDurability()
                            + " Attack: " + GameController.getInstance().monsters.get(monster).getStatus().getAttack()
                            + " Magic: " + GameController.getInstance().monsters.get(monster).getStatus().getMagic());
                    System.out.println("Drop Food: " + GameController.getInstance().monsters.get(monster).getFood().name
                            + ", Drop Potion: "
                            + GameController.getInstance().monsters.get(monster).getPotion().getName());
                } else if (option == 8) {
                    System.out.println("======================================================");
                    if (GameController.getInstance().players.size() == 0) {
                        System.out.println("There is no player");
                    ...
                    if (choice == 1) {
                        ...
                        for (int i = 0; i < GameController.getInstance().markets.get(market).getPotions().size(); i++) {
                            System.out.println("<" + i + "> "
                                    + GameController.getInstance().markets.get(market).getPotions().get(i).getName());
                            System.out.println("Increasing Status Hp: "
                                    + GameController.getInstance().markets.get(market).getPotions().get(i)
                                            .getIncreasingStatus().getHp()
                                    + " Durability: "
                                    + GameController.getInstance().markets.get(market).getPotions().get(i)
                                            .getIncreasingStatus().getDurability()
                                    + " Attack: "
                                    + GameController.getInstance().markets.get(market).getPotions().get(i)
                                            .getIncreasingStatus().getAttack()
                                    + " Magic: " + GameController.getInstance().markets.get(market).getPotions().get(i)
                                            .getIncreasingStatus().getMagic());
                            System.out.println("Price: "
                                    + GameController.getInstance().markets.get(market).getPotions().get(i).getPrice());
                        }
                        int potion = scan.nextInt();
                        if (potion < 0
                                || potion >= GameController.getInstance().markets.get(market).getPotions().size()) {
                            System.out.println("Error");
                            continue;
                        }
                        if (GameController.getInstance().players.get(player)
                                .getMoney() < GameController.getInstance().markets.get(market).getPotions().get(potion)
                                        .getPrice()) {
                            System.out.println("Your money is not enough to buy this potion");
                            continue;
                        }
                        System.out.println("Buy potion completed");
                        GameController.getInstance().players.get(player)
                                .setMoney(GameController.getInstance().players.get(player).getMoney()
                                        - GameController.getInstance().markets.get(market).getPotions().get(potion)
                                                .getPrice());
                        GameController.getInstance().players.get(player).getPotions()
                                .add(GameController.getInstance().markets.get(market).getPotions().get(potion));
                        GameController.getInstance().markets.get(market).getPotions()
                                .remove(GameController.getInstance().markets.get(market).getPotions().get(potion));
                    } else if (choice == 2) {
                        if (GameController.getInstance().markets.get(market).getFoods().size() == 0) {
                        ...
                        for (int i = 0; i < GameController.getInstance().markets.get(market).getFoods().size(); i++) {
                            System.out.println("<" + i + "> "
                                    + GameController.getInstance().markets.get(market).getFoods().get(i).name);
                            System.out.println("Price: "
                                    + GameController.getInstance().markets.get(market).getFoods().get(i).price
                                    + " Energy : "
                                    + GameController.getInstance().markets.get(market).getFoods().get(i).energy);
                        }
                        ...
                        if (GameController.getInstance().players.get(player)
                                .getMoney() < GameController.getInstance().markets.get(market).getFoods()
                                        .get(food).price) {
                        ...
                        GameController.getInstance().players.get(player)
                                .setMoney(GameController.getInstance().players.get(player).getMoney()
                                        - GameController.getInstance().markets.get(market).getFoods().get(food).price);
                        GameController.getInstance().players.get(player).getFoods()
                                .add(GameController.getInstance().markets.get(market).getFoods().get(food));
                        GameController.getInstance().markets.get(market).getFoods()
                                .remove(GameController.getInstance().markets.get(market).getFoods().get(food));
                    }
                } else if (option == 9) {
                    System.out.println("======================================================");
                    if (GameController.getInstance().players.size() == 0
                            || GameController.getInstance().monsters.size() == 0) {
                    ...
                    if (attack == 1) {
                        GameController.getInstance().players.get(player)
                                .attack(GameController.getInstance().monsters.get(monster));
                        System.out.println("Monster: " + GameController.getInstance().monsters.get(monster).getName()
                                + " now has hp "
                                + GameController.getInstance().monsters.get(monster).getStatus().getHp());
                    } else if (attack == 2) {
                        GameController.getInstance().players.get(player)
                                .magicAttack(GameController.getInstance().monsters.get(monster));
                        System.out.println("Monster: " + GameController.getInstance().monsters.get(monster).getName()
                                + " now has hp "
                                + GameController.getInstance().monsters.get(monster).getStatus().getHp());
                    } else {
                    ...
                    if (GameController.getInstance().monsters.get(monster).getStatus().getHp() <= 0) {
                        System.out.println(
                                "You got Food: " + GameController.getInstance().monsters.get(monster).getFood().name);
                        System.out.println("Price: "
                                + GameController.getInstance().monsters.get(monster).getFood().price + " Energy: "
                                + GameController.getInstance().monsters.get(monster).getFood().energy);
                        System.out.println("You got Potion: "
                                + GameController.getInstance().monsters.get(monster).getPotion().getName());
                        System.out.println(
                                "Price: " + GameController.getInstance().monsters.get(monster).getPotion().getPrice());
                        System.out.println("Increasing Status Hp: "
                                + GameController.getInstance().monsters.get(monster).getPotion().getIncreasingStatus()
                                        .getHp()
                                + " Durability: "
                                + GameController.getInstance().monsters.get(monster).getPotion().getIncreasingStatus()
                                        .getDurability()
                                ...
                                + GameController.getInstance().monsters.get(monster).getPotion().getIncreasingStatus()
                                        .getAttack()
                                + " Magic: " + GameController.getInstance().monsters.get(monster).getPotion()
                                        .getIncreasingStatus().getMagic());
                        GameController.getInstance().players.get(player).getFoods()
                                .add(GameController.getInstance().monsters.get(monster).getFood());
                        GameController.getInstance().players.get(player).getPotions()
                                .add(GameController.getInstance().monsters.get(monster).getPotion());
                    }
                    ...
                    int attack = scan.nextInt();
                    if (attack == 1) {
                        GameController.getInstance().monsters.get(monster)
                                .attack(GameController.getInstance().players.get(player));
                        System.out.println(
                                "Player: " + GameController.getInstance().players.get(player).getName() + " now has hp "
                                        + GameController.getInstance().players.get(player).getStatus().getHp());

                    } else if (attack == 2) {
                        GameController.getInstance().monsters.get(monster)
                                .magicAttack(GameController.getInstance().players.get(player));
                        System.out.println(
                                "Player: " + GameController.getInstance().players.get(player).getName() + " now has hp "
                                        + GameController.getInstance().players.get(player).getStatus().getHp());
                    } else {
                    ...
                    for (int i = 0; i < 4; i++) {
                        System.out.println("<" + i + "> " + GameController.getInstance().ores.get(i).name + " Cost: "
                                + GameController.getInstance().ores.get(i).cost);
                    }
                    ...
                    if (!GameController.getInstance().players.get(player)
                            .buyOre(GameController.getInstance().ores.get(ore))) {
                    ...
                    if (GameController.getInstance().players.get(player).getPotions().size() == 0) {
                        System.out.println(GameController.getInstance().players.get(player).getName()
                                + " does not have any potion");
                        continue;
                    }
                    ...
                    for (int i = 0; i < GameController.getInstance().players.get(player).getPotions().size(); i++) {
                        System.out.println("<" + i + "> "
                                + GameController.getInstance().players.get(player).getPotions().get(i).getName());
                        System.out.println("Increasing Status Hp : "
                                + GameController.getInstance().players.get(player).getPotions().get(i)
                                        .getIncreasingStatus().getHp()
                                + " Durability: "
                                + GameController.getInstance().players.get(player).getPotions().get(i)
                                        .getIncreasingStatus().getDurability()
                                ...
                                + GameController.getInstance().players.get(player).getPotions().get(i)
                                        .getIncreasingStatus().getAttack()
                                + " Magic: " + GameController.getInstance().players.get(player).getPotions().get(i)
                                        .getIncreasingStatus().getMagic());
                        System.out.println("Price: "
                                + GameController.getInstance().players.get(player).getPotions().get(i).getPrice());
                    }
                    int potion = scan.nextInt();
                    ...
                    if (GameController.getInstance().players.get(player).getFoods().size() == 0) {
                        System.out.println(
                                GameController.getInstance().players.get(player).getName() + " does not have any food");
                        continue;
                    }
                    System.out.println("Choose Food you want to eat");
                    for (int i = 0; i < GameController.getInstance().players.get(player).getFoods().size(); i++) {
                        System.out.println("<" + i + "> "
                                + GameController.getInstance().players.get(player).getFoods().get(i).name);
                        System.out.println(
                                "Energy: " + GameController.getInstance().players.get(player).getFoods().get(i).energy
                                        + " Price: "
                                        + GameController.getInstance().players.get(player).getFoods().get(i).price);
                    }
                    int food = scan.nextInt();
